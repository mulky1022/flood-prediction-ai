...
const localizedLocations = {
  ...
  2: { en: 'Colombo Fort', si: 'කොළඹ කොටුව', ta: 'கொழும்பு கோட்டை' },
  3: { en: 'Kelaniya', si: 'කැලණිය', ta: 'களனி' },
  4: { en: 'Ja-Ela', si: 'ජා-ඇල', ta: 'ஜா-எல' },
  5: { en: 'Kalutara South', si: 'දකුණු කළුතර', ta: 'தெற்கு களுத்துறை' },
  6: { en: 'Millaniya', si: 'මිල්ලනිය', ta: 'மில்லனிய' },
  7: { en: 'Ratnapura Town', si: 'රත්නපුරය', ta: 'இரத்தினபுரி' },
  8: { en: 'Pelmadulla', si: 'පැල්මඩුල්ල', ta: 'பெல்மதுல்ல' },
  9: { en: 'Kegalle Town', si: 'කෑගල්ල', ta: 'கேகாலை' },
  10: { en: 'Dehiowita', si: 'දෙහිඕවිට', ta: 'தெஹியோவிட்ட' },
  11: { en: 'Baddegama', si: 'බද්දේගම', ta: 'பத்தேகம' },
  12: { en: 'Galle Fort', si: 'ගාල්ල කොටුව', ta: 'காலி கோட்டை' },
  13: { en: 'Akuressa', si: 'අකුරැස්ස', ta: 'அக்குரெஸ்ஸ' },
  14: { en: 'Matara City', si: 'මාතර', ta: 'மாத்தறை' },
  15: { en: 'Tissamaharama', si: 'තිස්සමහාරාමය', ta: 'திஸ்ஸமஹாராம' },
  16: { en: 'Peradeniya', si: 'පේරාදෙණිය', ta: 'பேராதனை' },
  17: { en: 'Nawalapitiya', si: 'නාවලපිටිය', ta: 'நாவலப்பிட்டி' },
  18: { en: 'Matale Town', si: 'මාතලේ', ta: 'மாத்தளை' },
  19: { en: 'Nuwara Eliya Town', si: 'නුවරඑළිය', ta: 'நுவரெலியா' },
  20: { en: 'Kurunegala Town', si: 'කුරුණෑගල', ta: 'குருணாகல்' },
  21: { en: 'Chilaw', si: 'හලාවත', ta: 'சிலாபம்' },
  22: { en: 'Anuradhapura', si: 'අනුරාධපුරය', ta: 'அனுராதபுரம்' },
  23: { en: 'Manampitiya (Polonnaruwa)', si: 'මනම්පිටිය (පොළොන්නරුව)', ta: 'மனம்பிட்டிய (பொலன்னறுவை)' },
  24: { en: 'Mahiyanganaya', si: 'මහියංගණය', ta: 'மஹியங்கனை' },
  25: { en: 'Wellawaya', si: 'වැල්ලවාය', ta: 'வெல்லவாய' },
  26: { en: 'Batticaloa Town', si: 'මඩකලපුව', ta: 'மட்டக்களப்பு' },
  27: { en: 'Ampara (Kalmunai)', si: 'අම්පාර (කල්මුනේ)', ta: 'அம்பாறை (கல்முனை)' },
  28: { en: 'Kantale', si: 'කන්තලේ', ta: 'கந்தளாய்' },
  29: { en: 'Jaffna City', si: 'යාපනය', ta: 'யாழ்ப்பாணம்' },
  30: { en: 'Iranamadu', si: 'ඉරණමඩු', ta: 'இரணைமடு' },
  31: { en: 'Murunkan', si: 'මුරුන්කන්', ta: 'முருங்கன்' },
  32: { en: 'Vavuniya Town', si: 'වවුනියාව', ta: 'வவுனியா' },
  33: { en: 'Puthukkudiyiruppu', si: 'පුදුකුඩුඉරිප්පු', ta: 'புதுக்குடியிருப்பு' }
};
